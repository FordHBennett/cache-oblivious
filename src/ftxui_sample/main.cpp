...
// configuration step. It creates a namespace called `cache_oblivious`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cache_oblivious::cmake::project_name, cache_oblivious::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cache_oblivious::cmake::project_version);
      return EXIT_SUCCESS;
    }
